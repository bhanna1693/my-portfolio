...
ContactComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ContactComponent, selectors: [["app-contact"]], decls: 25, vars: 1, consts: [[1, "container"], [1, "d-flex", "justify-content-center"], [1, "w-75"], [1, "text-center"], [3, "formGroup", "ngSubmit"], [1, "contact-name-email-grid"], ["type", "text", "matInput", "", "formControlName", "name"], ["type", "text", "matInput", "", "formControlName", "email"], [1, "d-flex"], ["name", "message", "id", "message", "rows", "7", "matInput", "", "formControlName", "message"], ["type", "submit", "mat-flat-button", "", "color", "primary", 1, "py-3", "px-4", "submit-btn"]], template: function ContactComponent_Template(rf, ctx) { if (rf & 1) {
